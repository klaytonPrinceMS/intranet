...
check('get_config("cor_fundo"' in MAIN
      and 'ui.query(".q-page").style(f"background-color:{fundo_login}")' in MAIN,
      "/login usa cor_fundo configurável (body + .q-page, sem hardcoded)")
