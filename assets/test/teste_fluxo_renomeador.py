...
DOC_PDF = os.path.join(RAIZ, "assets", "test", "pdf", "DOC_0201.pdf")
...
def _redirecionar_para_temp():
    ...
    _repo.MODULOS_BD["empenhos"] = bd.DB_EMPENHO_PATH  # conexão via caminho_db
...
def _pdf(x):
    return os.path.join(RAIZ, "assets", "test", "pdf", f"{x}.pdf")
