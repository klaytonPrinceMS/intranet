        ...
        try:
            try:
                ...
                try:
                    ...
                    _obs_fail.get_logger("solicita_impressao").exception("mostrar_tela falhou")
        except Exception:
            pass
        try:
...
def _tela_nova(usuario_logado, eh_admin):
    ...
    try:
            ...
            with ui.card_section().classes("gap-2 w-full"):
                ...
                def rebuild():
                    try:
                        ...
                        try:
                            try:
                                _log().exception("rebuild falhou")
                            except NameError:
                                try:
                                    log.exception("rebuild falhou")
                                except NameError:
                                    from mod_intranet import observabilidade as _obs_fail
                                    _obs_fail.get_logger("solicita_impressao").exception("rebuild falhou")
                        except Exception:
                            pass
                        try:
                            from mod_intranet.tema_modulo import notificar as _notificar_fail
                ...
                def _remover_um(r):
                    try:
                        ...
                        try:
                            try:
                                _log().exception("_remover_um falhou")
                            except NameError:
                                try:
                                    log.exception("_remover_um falhou")
                                except NameError:
                                    from mod_intranet import observabilidade as _obs_fail
                                    _obs_fail.get_logger("solicita_impressao").exception("_remover_um falhou")
                        except Exception:
                            pass
                        try:
                            from mod_intranet.tema_modulo import notificar as _notificar_fail
                ...
                def _remover_selecionados():
                    try:
                        ...
                        try:
                            try:
                                _log().exception("_remover_selecionados falhou")
                            except NameError:
                                try:
                                    log.exception("_remover_selecionados falhou")
                                except NameError:
                                    from mod_intranet import observabilidade as _obs_fail
                                    _obs_fail.get_logger("solicita_impressao").exception("_remover_selecionados falhou")
                        except Exception:
                            pass
                        try:
                            from mod_intranet.tema_modulo import notificar as _notificar_fail
                ...
                async def ao_upload(e):
                    ...
                    try:
                        ...
                        try:
                            try:
                                _log().exception("ao_upload falhou")
                            except NameError:
                                try:
                                    log.exception("ao_upload falhou")
                                except NameError:
                                    from mod_intranet import observabilidade as _obs_fail
                                    _obs_fail.get_logger("solicita_impressao").exception("ao_upload falhou")
                        except Exception:
                            pass
                        try:
                            from mod_intranet.tema_modulo import notificar as _notificar_fail
                ...
                with ui.row().classes("w-full gap-2 flex-wrap items-end"):
                    ...
                    def ao_secretaria(e):
                        try:
                            ...
                            try:
                                try:
                                    _log().exception("ao_secretaria falhou")
                                except NameError:
                                    try:
                                        log.exception("ao_secretaria falhou")
                                    except NameError:
                                        from mod_intranet import observabilidade as _obs_fail
                                        _obs_fail.get_logger("solicita_impressao").exception("ao_secretaria falhou")
                            except Exception:
                                pass
                            try:
                                from mod_intranet.tema_modulo import notificar as _notificar_fail
                    ...
                    def ao_tipo_papel():
                        try:
                            ...
                            try:
                                try:
                                    _log().exception("ao_tipo_papel falhou")
                                except NameError:
                                    try:
                                        log.exception("ao_tipo_papel falhou")
                                    except NameError:
                                        from mod_intranet import observabilidade as _obs_fail
                                        _obs_fail.get_logger("solicita_impressao").exception("ao_tipo_papel falhou")
                            except Exception:
                                pass
                            try:
                                from mod_intranet.tema_modulo import notificar as _notificar_fail
                    ...
                    def ao_papel():
                        try:
                            ...
                            try:
                                try:
                                    _log().exception("ao_papel falhou")
                                except NameError:
                                    try:
                                        log.exception("ao_papel falhou")
                                    except NameError:
                                        from mod_intranet import observabilidade as _obs_fail
                                        _obs_fail.get_logger("solicita_impressao").exception("ao_papel falhou")
                            except Exception:
                                pass
                            try:
                                from mod_intranet.tema_modulo import notificar as _notificar_fail
                    ...
                    def toggle_borda():
                        try:
                            ...
                            try:
                                try:
                                    _log().exception("toggle_borda falhou")
                                except NameError:
                                    try:
                                        log.exception("toggle_borda falhou")
                                    except NameError:
                                        from mod_intranet import observabilidade as _obs_fail
                                        _obs_fail.get_logger("solicita_impressao").exception("toggle_borda falhou")
                            except Exception:
                                pass
                            try:
                                from mod_intranet.tema_modulo import notificar as _notificar_fail
                ...
                def tick():
                    try:
                        ...
                        try:
                            try:
                                _log().exception("tick falhou")
                            except NameError:
                                try:
                                    log.exception("tick falhou")
                                except NameError:
                                    from mod_intranet import observabilidade as _obs_fail
                                    _obs_fail.get_logger("solicita_impressao").exception("tick falhou")
                        except Exception:
                            pass
                        try:
                            from mod_intranet.tema_modulo import notificar as _notificar_fail
                ...
                def enviar():
                    try:
                        ...
                        try:
                            try:
                                _log().exception("enviar falhou")
                            except NameError:
                                try:
                                    log.exception("enviar falhou")
                                except NameError:
                                    from mod_intranet import observabilidade as _obs_fail
                                    _obs_fail.get_logger("solicita_impressao").exception("enviar falhou")
                        except Exception:
                            pass
                        try:
                            from mod_intranet.tema_modulo import notificar as _notificar_fail
        ...
        try:
            try:
                _log().exception("_tela_nova falhou")
            except NameError:
                try:
                    log.exception("_tela_nova falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_tela_nova falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
    ...
    try:
        ...
        def atualizar():
            try:
                ...
                try:
                    try:
                        _log().exception("atualizar falhou")
                    except NameError:
                        try:
                            log.exception("atualizar falhou")
                        except NameError:
                            from mod_intranet import observabilidade as _obs_fail
                            _obs_fail.get_logger("solicita_impressao").exception("atualizar falhou")
                except Exception:
                    pass
                try:
                    from mod_intranet.tema_modulo import notificar as _notificar_fail
        ...
        try:
            try:
                _log().exception("_tela_minhas falhou")
            except NameError:
                try:
                    log.exception("_tela_minhas falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_tela_minhas falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _tela_autorizar(usuario_logado, eh_admin):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_tela_autorizar falhou")
            except NameError:
                try:
                    log.exception("_tela_autorizar falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_tela_autorizar falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
    ...
    try:
        ...
        def _selecionados_fisicos():
            try:
                ...
                try:
                    try:
                        _log().exception("_selecionados_fisicos falhou")
                    except NameError:
                        try:
                            log.exception("_selecionados_fisicos falhou")
                        except NameError:
                            from mod_intranet import observabilidade as _obs_fail
                            _obs_fail.get_logger("solicita_impressao").exception("_selecionados_fisicos falhou")
                except Exception:
                    pass
                try:
                    from mod_intranet.tema_modulo import notificar as _notificar_fail
        ...
        def baixar_selecionados():
            try:
                ...
                try:
                    try:
                        _log().exception("baixar_selecionados falhou")
                    except NameError:
                        try:
                            log.exception("baixar_selecionados falhou")
                        except NameError:
                            from mod_intranet import observabilidade as _obs_fail
                            _obs_fail.get_logger("solicita_impressao").exception("baixar_selecionados falhou")
                except Exception:
                    pass
                try:
                    from mod_intranet.tema_modulo import notificar as _notificar_fail
        ...
        def baixar_selecionados_zip():
            try:
                ...
                try:
                    try:
                        _log().exception("baixar_selecionados_zip falhou")
                    except NameError:
                        try:
                            log.exception("baixar_selecionados_zip falhou")
                        except NameError:
                            from mod_intranet import observabilidade as _obs_fail
                            _obs_fail.get_logger("solicita_impressao").exception("baixar_selecionados_zip falhou")
                except Exception:
                    pass
                try:
                    from mod_intranet.tema_modulo import notificar as _notificar_fail
        ...
        try:
            try:
                _log().exception("_card_grupo falhou")
            except NameError:
                try:
                    log.exception("_card_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_card_grupo falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _baixar_arquivo(caminho, nome):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_baixar_arquivo falhou")
            except NameError:
                try:
                    log.exception("_baixar_arquivo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_baixar_arquivo falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _baixar(sol):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_baixar falhou")
            except NameError:
                try:
                    log.exception("_baixar falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_baixar falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _cancelar_grupo(grupo_id, usuario, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_cancelar_grupo falhou")
            except NameError:
                try:
                    log.exception("_cancelar_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_cancelar_grupo falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _reenviar_grupo(grupo_id, usuario, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_reenviar_grupo falhou")
            except NameError:
                try:
                    log.exception("_reenviar_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_reenviar_grupo falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _autorizar_grupo(grupo_id, usuario, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_autorizar_grupo falhou")
            except NameError:
                try:
                    log.exception("_autorizar_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_autorizar_grupo falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _recusar_grupo(grupo_id, usuario, atualizar):
    ...
    try:
                    ...
                    try:
                        try:
                            ...
                            try:
                                ...
                                from mod_intranet import observabilidade as _obs_fail
                                _obs_fail.get_logger("solicita_impressao").exception("confirmar falhou")
                    except Exception:
                        pass
                    try:
                        from mod_intranet.tema_modulo import notificar as _notificar_fail
        ...
        try:
            try:
                _log().exception("_recusar_grupo falhou")
            except NameError:
                try:
                    log.exception("_recusar_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_recusar_grupo falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _tela_admin(usuario_logado, eh_admin):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_tela_admin falhou")
            except NameError:
                try:
                    log.exception("_tela_admin falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_tela_admin falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
    ...
    try:
        ...
        def ao_aba(e):
            try:
                ...
                try:
                    try:
                        _log().exception("ao_aba falhou")
                    except NameError:
                        try:
                            log.exception("ao_aba falhou")
                        except NameError:
                            from mod_intranet import observabilidade as _obs_fail
                            _obs_fail.get_logger("solicita_impressao").exception("ao_aba falhou")
                except Exception:
                    pass
                try:
                    from mod_intranet.tema_modulo import notificar as _notificar_fail
        ...
        try:
            try:
                _log().exception("_admin_solicitacoes falhou")
            except NameError:
                try:
                    log.exception("_admin_solicitacoes falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_admin_solicitacoes falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _card_admin_grupo(g, usuario_logado, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_card_admin_grupo falhou")
            except NameError:
                try:
                    log.exception("_card_admin_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_card_admin_grupo falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
    ...
    try:
        ...
        def disparar():
            try:
                ...
                try:
                    try:
                        _log().exception("disparar falhou")
                    except NameError:
                        try:
                            log.exception("disparar falhou")
                        except NameError:
                            from mod_intranet import observabilidade as _obs_fail
                            _obs_fail.get_logger("solicita_impressao").exception("disparar falhou")
                except Exception:
                    pass
                try:
                    from mod_intranet.tema_modulo import notificar as _notificar_fail
        ...
        try:
            try:
                _log().exception("_imprimir_grupo falhou")
            except NameError:
                try:
                    log.exception("_imprimir_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_imprimir_grupo falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _confirmar_impressao_grupo(grupo_id, usuario, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_confirmar_impressao_grupo falhou")
            except NameError:
                try:
                    log.exception("_confirmar_impressao_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_confirmar_impressao_grupo falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _recuar_grupo(grupo_id, usuario, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_recuar_grupo falhou")
            except NameError:
                try:
                    log.exception("_recuar_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_recuar_grupo falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _imprimir(sid, usuario, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_imprimir falhou")
            except NameError:
                try:
                    log.exception("_imprimir falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_imprimir falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _confirmar_impressao(sid, usuario, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_confirmar_impressao falhou")
            except NameError:
                try:
                    log.exception("_confirmar_impressao falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_confirmar_impressao falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _recuar(sid, usuario, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_recuar falhou")
            except NameError:
                try:
                    log.exception("_recuar falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_recuar falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _admin_secretarias(usuario_logado):
    ...
    try:
                        ...
                        try:
                            try:
                                ...
                                try:
                                    ...
                                    from mod_intranet import observabilidade as _obs_fail
                                    _obs_fail.get_logger("solicita_impressao").exception("criar falhou")
                        except Exception:
                            pass
                        try:
                            from mod_intranet.tema_modulo import notificar as _notificar_fail
        ...
        try:
            try:
                _log().exception("_admin_secretarias falhou")
            except NameError:
                try:
                    log.exception("_admin_secretarias falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_admin_secretarias falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _editar_secretaria(sid, nome, sigla, cota, lim, usuario, atualizar):
    ...
    try:
                    ...
                    try:
                        try:
                            ...
                            try:
                                ...
                                from mod_intranet import observabilidade as _obs_fail
                                _obs_fail.get_logger("solicita_impressao").exception("salvar falhou")
                    except Exception:
                        pass
                    try:
                        from mod_intranet.tema_modulo import notificar as _notificar_fail
        ...
        try:
            try:
                _log().exception("_editar_secretaria falhou")
            except NameError:
                try:
                    log.exception("_editar_secretaria falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_editar_secretaria falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _excluir_secretaria(sid, usuario, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_excluir_secretaria falhou")
            except NameError:
                try:
                    log.exception("_excluir_secretaria falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_excluir_secretaria falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _admin_setores(usuario_logado):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_admin_setores falhou")
            except NameError:
                try:
                    log.exception("_admin_setores falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_admin_setores falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _editar_setor(stid, nome, secr, cota, lim, usuario, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_editar_setor falhou")
            except NameError:
                try:
                    log.exception("_editar_setor falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_editar_setor falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _excluir_setor(stid, usuario, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_excluir_setor falhou")
            except NameError:
                try:
                    log.exception("_excluir_setor falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_excluir_setor falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _admin_responsaveis(usuario_logado):
    ...
    try:
            ...
            with ui.row().classes("w-full gap-2"):
                ...
                def ao_secr(e):
                    try:
                        ...
                        try:
                            try:
                                _log().exception("ao_secr falhou")
                            except NameError:
                                try:
                                    log.exception("ao_secr falhou")
                                except NameError:
                                    from mod_intranet import observabilidade as _obs_fail
                                    _obs_fail.get_logger("solicita_impressao").exception("ao_secr falhou")
                        except Exception:
                            pass
                        try:
                            from mod_intranet.tema_modulo import notificar as _notificar_fail
        ...
        try:
            try:
                _log().exception("_admin_responsaveis falhou")
            except NameError:
                try:
                    log.exception("_admin_responsaveis falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_admin_responsaveis falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _excluir_resp(rid, usuario, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_excluir_resp falhou")
            except NameError:
                try:
                    log.exception("_excluir_resp falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_excluir_resp falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _admin_cotas(usuario_logado):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_admin_cotas falhou")
            except NameError:
                try:
                    log.exception("_admin_cotas falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_admin_cotas falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _editar_cota(secr, setor, cota_atual, usuario, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_editar_cota falhou")
            except NameError:
                try:
                    log.exception("_editar_cota falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_editar_cota falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _resetar_cota(secr, setor, usuario, atualizar):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_resetar_cota falhou")
            except NameError:
                try:
                    log.exception("_resetar_cota falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_resetar_cota falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _admin_configuracoes(usuario_logado):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_admin_configuracoes falhou")
            except NameError:
                try:
                    log.exception("_admin_configuracoes falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_admin_configuracoes falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
...
def _painel_impressoras(usuario_logado):
    ...
    try:
        ...
        with ui.column().classes("w-full gap-2"):
            ...
            def _def_padrao(pid, atualizar):
                try:
                    ...
                    try:
                        try:
                            _log().exception("_def_padrao falhou")
                        except NameError:
                            try:
                                log.exception("_def_padrao falhou")
                            except NameError:
                                from mod_intranet import observabilidade as _obs_fail
                                _obs_fail.get_logger("solicita_impressao").exception("_def_padrao falhou")
                    except Exception:
                        pass
                    try:
                        from mod_intranet.tema_modulo import notificar as _notificar_fail
            ...
            def _excluir_imp(pid, atualizar):
                try:
                    ...
                    try:
                        try:
                            _log().exception("_excluir_imp falhou")
                        except NameError:
                            try:
                                log.exception("_excluir_imp falhou")
                            except NameError:
                                from mod_intranet import observabilidade as _obs_fail
                                _obs_fail.get_logger("solicita_impressao").exception("_excluir_imp falhou")
                    except Exception:
                        pass
                    try:
                        from mod_intranet.tema_modulo import notificar as _notificar_fail
        ...
        try:
            try:
                _log().exception("_painel_impressoras falhou")
            except NameError:
                try:
                    log.exception("_painel_impressoras falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_painel_impressoras falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
    ...
    try:
        ...
        def _prazo_fixo(tipo):
            try:
                ...
                try:
                    try:
                        _log().exception("_prazo_fixo falhou")
                    except NameError:
                        try:
                            log.exception("_prazo_fixo falhou")
                        except NameError:
                            from mod_intranet import observabilidade as _obs_fail
                            _obs_fail.get_logger("solicita_impressao").exception("_prazo_fixo falhou")
                except Exception:
                    pass
                try:
                    from mod_intranet.tema_modulo import notificar as _notificar_fail
        ...
        def gerar():
            try:
                ...
                try:
                    try:
                        _log().exception("gerar falhou")
                    except NameError:
                        try:
                            log.exception("gerar falhou")
                        except NameError:
                            from mod_intranet import observabilidade as _obs_fail
                            _obs_fail.get_logger("solicita_impressao").exception("gerar falhou")
                except Exception:
                    pass
                try:
                    from mod_intranet.tema_modulo import notificar as _notificar_fail
        ...
        try:
            try:
                _log().exception("_admin_relatorio falhou")
            except NameError:
                try:
                    log.exception("_admin_relatorio falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_admin_relatorio falhou")
        except Exception:
            pass
        try:
            from mod_intranet.tema_modulo import notificar as _notificar_fail
