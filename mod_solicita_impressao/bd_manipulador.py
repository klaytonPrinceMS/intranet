        ...
        try:
            try:
                ...
                try:
                    ...
                    _obs_fail.get_logger("solicita_impressao").exception("get_connection falhou")
        except Exception:
            pass
        raise
    ...
    try:
        ...
        def _sigla_sec(nome):
            try:
                ...
                try:
                    try:
                        _log().exception("_sigla_sec falhou")
                    except NameError:
                        try:
                            log.exception("_sigla_sec falhou")
                        except NameError:
                            from mod_intranet import observabilidade as _obs_fail
                            _obs_fail.get_logger("solicita_impressao").exception("_sigla_sec falhou")
                except Exception:
                    pass
                return None
        ...
        try:
            try:
                ...
                try:
                    ...
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("init_db falhou")
        except Exception:
            pass
        return None
...
def criar_impressora(nome, tamanho_papel="A4", cor="Color", frente_verso=0,
    ...
    try:
        ...
        try:
            try:
                _log().exception("criar_impressora falhou")
            except NameError:
                try:
                    log.exception("criar_impressora falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("criar_impressora falhou")
        except Exception:
            pass
...
def listar_impressoras(ativo=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("listar_impressoras falhou")
            except NameError:
                try:
                    log.exception("listar_impressoras falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("listar_impressoras falhou")
        except Exception:
            pass
        return []
...
def obter_impressora(impressora_id):
    ...
    try:
        ...
        try:
            try:
                _log().exception("obter_impressora falhou")
            except NameError:
                try:
                    log.exception("obter_impressora falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("obter_impressora falhou")
        except Exception:
            pass
        return None
...
def excluir_impressora(impressora_id, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("excluir_impressora falhou")
            except NameError:
                try:
                    log.exception("excluir_impressora falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("excluir_impressora falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def definir_impressora_padrao(impressora_id, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("definir_impressora_padrao falhou")
            except NameError:
                try:
                    log.exception("definir_impressora_padrao falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("definir_impressora_padrao falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def contar_paginas_pdf(caminho):
    ...
    try:
        ...
        try:
            try:
                _log().exception("contar_paginas_pdf falhou")
            except NameError:
                try:
                    log.exception("contar_paginas_pdf falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("contar_paginas_pdf falhou")
        except Exception:
            pass
        return 0
...
def criar_secretaria(nome, sigla="", cota_paginas_mensal=0, limite_pedidos_abertos=0,
    ...
    try:
        ...
        try:
            try:
                _log().exception("criar_secretaria falhou")
            except NameError:
                try:
                    log.exception("criar_secretaria falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("criar_secretaria falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def listar_secretarias(ativo=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("listar_secretarias falhou")
            except NameError:
                try:
                    log.exception("listar_secretarias falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("listar_secretarias falhou")
        except Exception:
            pass
        return []
...
def obter_secretaria(secretaria_id):
    ...
    try:
        ...
        try:
            try:
                _log().exception("obter_secretaria falhou")
            except NameError:
                try:
                    log.exception("obter_secretaria falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("obter_secretaria falhou")
        except Exception:
            pass
        return None
...
def editar_secretaria(secretaria_id, nome=None, sigla=None, cota_paginas_mensal=None,
    ...
    try:
        ...
        try:
            try:
                _log().exception("editar_secretaria falhou")
            except NameError:
                try:
                    log.exception("editar_secretaria falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("editar_secretaria falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def excluir_secretaria(secretaria_id, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("excluir_secretaria falhou")
            except NameError:
                try:
                    log.exception("excluir_secretaria falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("excluir_secretaria falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def criar_setor(nome, secretaria_id, cota_paginas_mensal=0, limite_pedidos_abertos=0,
    ...
    try:
        ...
        try:
            try:
                _log().exception("criar_setor falhou")
            except NameError:
                try:
                    log.exception("criar_setor falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("criar_setor falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def listar_setores(secretaria_id=None, ativo=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("listar_setores falhou")
            except NameError:
                try:
                    log.exception("listar_setores falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("listar_setores falhou")
        except Exception:
            pass
        return []
...
def obter_setor(setor_id):
    ...
    try:
        ...
        try:
            try:
                _log().exception("obter_setor falhou")
            except NameError:
                try:
                    log.exception("obter_setor falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("obter_setor falhou")
        except Exception:
            pass
        return None
...
def editar_setor(setor_id, nome=None, secretaria_id=None, cota_paginas_mensal=None,
    ...
    try:
        ...
        try:
            try:
                _log().exception("editar_setor falhou")
            except NameError:
                try:
                    log.exception("editar_setor falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("editar_setor falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def excluir_setor(setor_id, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("excluir_setor falhou")
            except NameError:
                try:
                    log.exception("excluir_setor falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("excluir_setor falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def criar_responsavel(user_nome, secretaria_id, setor_id=None, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("criar_responsavel falhou")
            except NameError:
                try:
                    log.exception("criar_responsavel falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("criar_responsavel falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def listar_responsaveis(secretaria_id=None, setor_id=None, ativo=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("listar_responsaveis falhou")
            except NameError:
                try:
                    log.exception("listar_responsaveis falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("listar_responsaveis falhou")
        except Exception:
            pass
        return []
...
def excluir_responsavel(responsavel_id, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("excluir_responsavel falhou")
            except NameError:
                try:
                    log.exception("excluir_responsavel falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("excluir_responsavel falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def eh_responsavel_autorizacao(user_nome, secretaria_id, setor_id=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("eh_responsavel_autorizacao falhou")
            except NameError:
                try:
                    log.exception("eh_responsavel_autorizacao falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("eh_responsavel_autorizacao falhou")
        except Exception:
            pass
        return None
...
def obter_ou_criar_cota(secretaria_id, setor_id, mes=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("obter_ou_criar_cota falhou")
            except NameError:
                try:
                    log.exception("obter_ou_criar_cota falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("obter_ou_criar_cota falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def definir_cota(secretaria_id, setor_id, cota_paginas, mes=None, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("definir_cota falhou")
            except NameError:
                try:
                    log.exception("definir_cota falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("definir_cota falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def obter_consumo(secretaria_id, setor_id, mes=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("obter_consumo falhou")
            except NameError:
                try:
                    log.exception("obter_consumo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("obter_consumo falhou")
        except Exception:
            pass
        return 0
...
def _incrementar_consumo(secretaria_id, setor_id, paginas, mes=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_incrementar_consumo falhou")
            except NameError:
                try:
                    log.exception("_incrementar_consumo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_incrementar_consumo falhou")
        except Exception:
            pass
        return None
...
def verificar_excedente(secretaria_id, setor_id, paginas_contabilizadas):
    ...
    try:
        ...
        try:
            try:
                _log().exception("verificar_excedente falhou")
            except NameError:
                try:
                    log.exception("verificar_excedente falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("verificar_excedente falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def resetar_consumo(secretaria_id, setor_id, mes=None, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("resetar_consumo falhou")
            except NameError:
                try:
                    log.exception("resetar_consumo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("resetar_consumo falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def obter_limite_pedidos_abertos(secretaria_id, setor_id=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("obter_limite_pedidos_abertos falhou")
            except NameError:
                try:
                    log.exception("obter_limite_pedidos_abertos falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("obter_limite_pedidos_abertos falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def contar_pedidos_abertos(secretaria_id, setor_id=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("contar_pedidos_abertos falhou")
            except NameError:
                try:
                    log.exception("contar_pedidos_abertos falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("contar_pedidos_abertos falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def verificar_limite_pedidos(secretaria_id, setor_id=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("verificar_limite_pedidos falhou")
            except NameError:
                try:
                    log.exception("verificar_limite_pedidos falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("verificar_limite_pedidos falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def percentual_consumo(secretaria_id, setor_id, mes=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("percentual_consumo falhou")
            except NameError:
                try:
                    log.exception("percentual_consumo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("percentual_consumo falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente.", None
...
def gerar_nome_arquivo(data_hora, usuario, qtd_copias, qtd_paginas, secretaria_id, setor_id,
    ...
    try:
        ...
        try:
            try:
                _log().exception("gerar_nome_arquivo falhou")
            except NameError:
                try:
                    log.exception("gerar_nome_arquivo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("gerar_nome_arquivo falhou")
        except Exception:
            pass
        return None
...
def criar_solicitacao(usuario, caminho_tmp, arquivo_original, qtd_copias, tamanho_papel,
    ...
    try:
        ...
        try:
            try:
                _log().exception("criar_solicitacao falhou")
            except NameError:
                try:
                    log.exception("criar_solicitacao falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("criar_solicitacao falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def tem_responsavel_para(secretaria_id, setor_id):
    ...
    try:
        ...
        try:
            try:
                _log().exception("tem_responsavel_para falhou")
            except NameError:
                try:
                    log.exception("tem_responsavel_para falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("tem_responsavel_para falhou")
        except Exception:
            pass
        return None
...
def listar_solicitacoes(usuario=None, status=None, secretaria_id=None, setor_id=None,
    ...
    try:
        ...
        try:
            try:
                _log().exception("listar_solicitacoes falhou")
            except NameError:
                try:
                    log.exception("listar_solicitacoes falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("listar_solicitacoes falhou")
        except Exception:
            pass
        return []
...
def contar_solicitacoes_pendentes():
    ...
    try:
        ...
        try:
            try:
                _log().exception("contar_solicitacoes_pendentes falhou")
            except NameError:
                try:
                    log.exception("contar_solicitacoes_pendentes falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("contar_solicitacoes_pendentes falhou")
        except Exception:
            pass
        return 0
...
def obter_solicitacao(solicitacao_id):
    ...
    try:
        ...
        try:
            try:
                _log().exception("obter_solicitacao falhou")
            except NameError:
                try:
                    log.exception("obter_solicitacao falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("obter_solicitacao falhou")
        except Exception:
            pass
        return None
...
def autorizar_solicitacao(solicitacao_id, autor, motivo=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("autorizar_solicitacao falhou")
            except NameError:
                try:
                    log.exception("autorizar_solicitacao falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("autorizar_solicitacao falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def recusar_solicitacao(solicitacao_id, autor, motivo):
    ...
    try:
        ...
        try:
            try:
                _log().exception("recusar_solicitacao falhou")
            except NameError:
                try:
                    log.exception("recusar_solicitacao falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("recusar_solicitacao falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def imprimir_solicitacao(solicitacao_id, admin_user, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("imprimir_solicitacao falhou")
            except NameError:
                try:
                    log.exception("imprimir_solicitacao falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("imprimir_solicitacao falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def recuar_solicitacao(solicitacao_id, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("recuar_solicitacao falhou")
            except NameError:
                try:
                    log.exception("recuar_solicitacao falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("recuar_solicitacao falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def cancelar_solicitacao(solicitacao_id, usuario, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("cancelar_solicitacao falhou")
            except NameError:
                try:
                    log.exception("cancelar_solicitacao falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("cancelar_solicitacao falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def _remover_arquivo_se_existir(caminho):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_remover_arquivo_se_existir falhou")
            except NameError:
                try:
                    log.exception("_remover_arquivo_se_existir falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_remover_arquivo_se_existir falhou")
        except Exception:
            pass
        return None
...
def registrar_rascunho(usuario, conteudo_bytes, nome_original):
    ...
    try:
        ...
        try:
            try:
                _log().exception("registrar_rascunho falhou")
            except NameError:
                try:
                    log.exception("registrar_rascunho falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("registrar_rascunho falhou")
        except Exception:
            pass
        return None
...
def obter_rascunho(rascunho_id):
    ...
    try:
        ...
        try:
            try:
                _log().exception("obter_rascunho falhou")
            except NameError:
                try:
                    log.exception("obter_rascunho falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("obter_rascunho falhou")
        except Exception:
            pass
        return None
...
def cancelar_rascunho(rascunho_id, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("cancelar_rascunho falhou")
            except NameError:
                try:
                    log.exception("cancelar_rascunho falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("cancelar_rascunho falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def confirmar_rascunho(rascunho_id, qtd_copias, tamanho_papel, cor, frente_verso,
    ...
    try:
        ...
        try:
            try:
                _log().exception("confirmar_rascunho falhou")
            except NameError:
                try:
                    log.exception("confirmar_rascunho falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("confirmar_rascunho falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente.", None
...
def _proximo_grupo_id():
    ...
    try:
        ...
        try:
            try:
                _log().exception("_proximo_grupo_id falhou")
            except NameError:
                try:
                    log.exception("_proximo_grupo_id falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_proximo_grupo_id falhou")
        except Exception:
            pass
        return 0
...
def confirmar_lote(usuario, rascunho_ids, qtd_copias, tamanho_papel, cor, frente_verso,
    ...
    try:
        ...
        try:
            try:
                _log().exception("confirmar_lote falhou")
            except NameError:
                try:
                    log.exception("confirmar_lote falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("confirmar_lote falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente.", None
...
def listar_pedidos(usuario=None, status=None, secretaria_id=None, setor_id=None,
    ...
    try:
        ...
        try:
            try:
                _log().exception("listar_pedidos falhou")
            except NameError:
                try:
                    log.exception("listar_pedidos falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("listar_pedidos falhou")
        except Exception:
            pass
        return []
...
def listar_arquivos_grupo(grupo_id):
    ...
    try:
        ...
        try:
            try:
                _log().exception("listar_arquivos_grupo falhou")
            except NameError:
                try:
                    log.exception("listar_arquivos_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("listar_arquivos_grupo falhou")
        except Exception:
            pass
        return []
...
def listar_pedidos_responsavel(user_nome, status=None, limite=200, busca=None,
    ...
    try:
        ...
        try:
            try:
                _log().exception("listar_pedidos_responsavel falhou")
            except NameError:
                try:
                    log.exception("listar_pedidos_responsavel falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("listar_pedidos_responsavel falhou")
        except Exception:
            pass
        return []
...
def _atualizar_status_grupo(grupo_id, status, campos=None, cond_status=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_atualizar_status_grupo falhou")
            except NameError:
                try:
                    log.exception("_atualizar_status_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_atualizar_status_grupo falhou")
        except Exception:
            pass
        return None
...
def autorizar_grupo(grupo_id, autor, motivo=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("autorizar_grupo falhou")
            except NameError:
                try:
                    log.exception("autorizar_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("autorizar_grupo falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def recusar_grupo(grupo_id, autor, motivo):
    ...
    try:
        ...
        try:
            try:
                _log().exception("recusar_grupo falhou")
            except NameError:
                try:
                    log.exception("recusar_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("recusar_grupo falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def imprimir_grupo(grupo_id, admin_user, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("imprimir_grupo falhou")
            except NameError:
                try:
                    log.exception("imprimir_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("imprimir_grupo falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def recuar_grupo(grupo_id, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("recuar_grupo falhou")
            except NameError:
                try:
                    log.exception("recuar_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("recuar_grupo falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def cancelar_grupo(grupo_id, usuario, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("cancelar_grupo falhou")
            except NameError:
                try:
                    log.exception("cancelar_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("cancelar_grupo falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def reenviar_grupo(grupo_id, usuario, ator="sistema"):
    ...
    try:
        ...
        try:
            try:
                _log().exception("reenviar_grupo falhou")
            except NameError:
                try:
                    log.exception("reenviar_grupo falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("reenviar_grupo falhou")
        except Exception:
            pass
        return False, "Erro interno. Tente novamente."
...
def expirar_rascunhos_e_impressos():
    ...
    try:
        ...
        try:
            try:
                _log().exception("expirar_rascunhos_e_impressos falhou")
            except NameError:
                try:
                    log.exception("expirar_rascunhos_e_impressos falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("expirar_rascunhos_e_impressos falhou")
        except Exception:
            pass
        return 0
...
def solicitar_solicitacoes_responsavel(user_nome, limite=200):
    ...
    try:
        ...
        try:
            try:
                _log().exception("solicitar_solicitacoes_responsavel falhou")
            except NameError:
                try:
                    log.exception("solicitar_solicitacoes_responsavel falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("solicitar_solicitacoes_responsavel falhou")
        except Exception:
            pass
        return None
...
def relatorio_cotas(mes=None):
    ...
    try:
        ...
        try:
            try:
                _log().exception("relatorio_cotas falhou")
            except NameError:
                try:
                    log.exception("relatorio_cotas falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("relatorio_cotas falhou")
        except Exception:
            pass
        return []
...
def _agregar_impressao(data_inicio, data_fim, agrupar_por):
    ...
    try:
        ...
        try:
            try:
                _log().exception("_agregar_impressao falhou")
            except NameError:
                try:
                    log.exception("_agregar_impressao falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("_agregar_impressao falhou")
        except Exception:
            pass
        return None
    ...
    try:
        ...
        def _por_secretaria():
            try:
                ...
                try:
                    try:
                        _log().exception("_por_secretaria falhou")
                    except NameError:
                        try:
                            log.exception("_por_secretaria falhou")
                        except NameError:
                            from mod_intranet import observabilidade as _obs_fail
                            _obs_fail.get_logger("solicita_impressao").exception("_por_secretaria falhou")
                except Exception:
                    pass
                return None
        ...
        def _por_setor():
            try:
                ...
                try:
                    try:
                        _log().exception("_por_setor falhou")
                    except NameError:
                        try:
                            log.exception("_por_setor falhou")
                        except NameError:
                            from mod_intranet import observabilidade as _obs_fail
                            _obs_fail.get_logger("solicita_impressao").exception("_por_setor falhou")
                except Exception:
                    pass
                return None
        ...
        def _por_autorizador():
            try:
                ...
                try:
                    try:
                        _log().exception("_por_autorizador falhou")
                    except NameError:
                        try:
                            log.exception("_por_autorizador falhou")
                        except NameError:
                            from mod_intranet import observabilidade as _obs_fail
                            _obs_fail.get_logger("solicita_impressao").exception("_por_autorizador falhou")
                except Exception:
                    pass
                return None
        ...
        def _por_impressor():
            try:
                ...
                try:
                    try:
                        _log().exception("_por_impressor falhou")
                    except NameError:
                        try:
                            log.exception("_por_impressor falhou")
                        except NameError:
                            from mod_intranet import observabilidade as _obs_fail
                            _obs_fail.get_logger("solicita_impressao").exception("_por_impressor falhou")
                except Exception:
                    pass
                return None
        ...
        try:
            try:
                _log().exception("relatorio_impressao falhou")
            except NameError:
                try:
                    log.exception("relatorio_impressao falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("relatorio_impressao falhou")
        except Exception:
            pass
        return []
...
def aplicar_marca_dagua(caminho_pdf, solicitacao_id, usuario, secretaria_nome,
    ...
    try:
        ...
        try:
            try:
                _log().exception("aplicar_marca_dagua falhou")
            except NameError:
                try:
                    log.exception("aplicar_marca_dagua falhou")
                except NameError:
                    from mod_intranet import observabilidade as _obs_fail
                    _obs_fail.get_logger("solicita_impressao").exception("aplicar_marca_dagua falhou")
        except Exception:
            pass
        return None
